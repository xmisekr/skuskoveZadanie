    ...
    <body>
        ...
        <section class="dashboard">
            ...
            <div class="container">
                    ...
                    <tbody class="tests-body">
                        <?php foreach($tests as $test): ?>
                            <tr class="tests-row row2">
                                ...
                                <td class="cell"><a href="<?php echo '../listStudents/listStudents.php?test_id=' . $test['id'] ?>"><i class="fa fa-external-link" aria-hidden="true"></i></a></td>
                ...
                <div class="new-test">
                    <a href="../createTest/createTest.php" class="create-test">New test</a>
                </div>
            </div>
