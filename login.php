...
<form action="login.php" method="post">
    <div class="col text-center" id="formDiv" style="max-width: 330px">
        ...
        <div class="row form-group" style="margin-left: 2px">
            <button class="btn btn-lg btn-info " id="studentBTN" onclick="student(); return false;"
                    style="width: 48%; background-color: #2C606A" ;>Student
            </button>
            <button class="btn btn-lg btn-info" id="teacherBTN" onclick="teacher(); return false;" style="width: 48%">
                Teacher
            </button>
        </div>
        <div id="formContent">
